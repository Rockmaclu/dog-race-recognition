...
def loadImage(image,name):
    ...
    cur.execute('INSERT INTO images (name,vector) VALUES (%s,%s);',[name,stringVector])
...
def main():
    ...
    if args.action == 'queryImage':
        ...
        print(getCloseImages(image,args.range))
